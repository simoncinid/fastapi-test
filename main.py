...
try:
    # Verifica se Requestor è disponibile
    if hasattr(openai, "api_requestor") and hasattr(openai.api_requestor, "Requestor"):
        openai.api_requestor.Requestor.DEFAULT_HEADERS["OpenAI-Beta"] = "assistants=v2"
    else:
        raise AttributeError
except AttributeError:
    raise RuntimeError("Impossibile impostare l'intestazione 'OpenAI-Beta: assistants=v2' perché 'openai.api_requestor.Requestor' non è disponibile.")
